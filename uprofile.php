...
<div class="w3-top ">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="ucontact" class="w3-bar-item w3-button"><i class="fa fa-phone"></i>Contact</a>
...
<div class="w3-container" id="Profile" style="margin-top: 20px">
  ...
  <div>
	<br><label><b>Username:</b><center><label><input type="text" name="t1" size="50" height="100px" value=""/></center><br>
	<br><label><b>Date-Of-Birth:</b><center></label><input type="date" name="t2" size="50" height="100px" /></center>
	<br><br><label><b>Age:</b><center></label><input type="text" name="t3" size="50" height="100px" /></center>
	<br><br><label><b>Gender:</b><center></label><select name="t4" ><option value="Male">Male</option><option value="Female">Female</option><option value="Other">Other</option></select></center>
	<br><br><label><b>Mobile Number:</b><center></label><input type="text" name="t5" size="50" height="100px" /></center>
<br><br><label><b>Email.id:</b><center></label><input type="text" name="t6" size="50" height="100px" /></center>
<br><br><center><input type="submit" value="save" name="submit"/><input type="submit" value="Update" name="submit"/></center>
	<a href="ueditprofile.php" onclick="w3_close()" class="w3-button w3-block w3-black w3-section w3-padding">Check</a>
</form>
	</div>
</div>
	</header>
...
mysql_query("select * from uprofile");
if($_POST['submit']=="save")
{

mysql_query("insert into uprofile(name,dob,age,gender,phno,email) values('".$name."','".$dob."','".$age."','".$gender."','".$phno."','".$email."')") or die("Values Cannot be inserted");
echo '<script type="text/javascript">alert("Data Inserted")</script>';
}
else if($_POST['submit']=="Update")
{
$update=mysql_query("UPDATE uprofile SET dob='".$dob."', age=".$age.",email='".$email."',phno='".$phno."',gender='".$gender."' where name='".$name."'") or die("Values Cannot be inserted");
