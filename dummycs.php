...
{ 
$query = mysql_query("SELECT * FROM cstatus where fir = '$_POST[t1]' AND name = '$_POST[t2]'") or die(mysql_error());
...
<form name="f1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<fieldset><legend><B>Enter the Value</legend>
		...
		<tr><td>Fir NO:</td><td></td><td><input type="text" name="t1"  required/></td></tr>
...
<form name="f2"  >
		<fieldset><legend><b>View Status</legend>
			...
			<tr><td>Fir No:</td><td></td><td><font color="red" size="4%"><?php echo $fir;?></font></td></tr>
