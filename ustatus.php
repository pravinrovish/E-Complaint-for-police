...
<!-- Navbar (sit on top) -->
  ...
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="ustatus.php" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i> Status</a>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" >
  <div class="w3-display-center w3-text-white" style="padding:48px">
    ...
    <span class="w3-large">An Police complaint Portal.</span>
    
</div>
<div class="w3-container" id="Profile" style="margin-top:10px">
    <h1 class="w3-animate-zoom w3-text-black">Status</h1>
...
{
?>
<tr><td><?php echo $row["name"]?></td><td><?php echo $row["accusation"]?></td>
<td><?php echo $row["fir"]?></td><td><?php echo $row["charge"]?></td>
<td><?php echo $row["filedon"]?></td><td><?php echo $row["enquired"]?></td>
<td><?php echo $row["caseon"]?></td><td><?php echo $row["status"]?></td></tr>
<?php
}
?>
</table>
...
mysql_connect('localhost','root','') or die("Cound not Connect");
mysql_select_db("e-complaint") or die("not create");
mysql_query("select * from ucomplaint where name=$name");
