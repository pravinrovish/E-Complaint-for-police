...
<div class="w3-container" id="contact" style="margin-top:20px">
    <h1 class="w3-xxxlarge w3-text-black"><b>Contact</b></h1>
    <div class="w3-row w3-padding-32 w3-text-black">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker w3-text-white" style="width:30px"></i> Tamil Nadu, INDIA<br>
        <i class="fa fa-phone w3-text-white" style="width:30px"></i> Phone: +91 9514126544<br>
        <i class="fa fa-envelope w3-text-white" style="width:30px"> </i> Email: prawinrovish@gmail.com<br>
      </div>
</div>
</div>
</div>
