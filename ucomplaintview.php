...
<div class="w3-display-center"id="new-div">
<center>
<table class= "w3-center"border="1" id="myTable">
...
<th>district</th><th>police station</th>
<th>type</th>
...
{
?>
<tr><td><?php echo $row["district"]?></td><td><?php echo $row["pstation"]?></td>
<td><?php echo $row["type"]?></td><td><?php echo $row["date"]?></td>
<td><?php echo $row["place"]?></td><td><?php echo $row["description"]?></td></tr>
<?php
}
?>
</table>
